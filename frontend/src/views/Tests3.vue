			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup0">
						...
						<p>Выбрано:{{ ($root.c[0].id_answer = radioGroup0[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup1">
						...
						<p>Выбрано:{{ ($root.c[1].id_answer = radioGroup1[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup2">
						...
						<p>Выбрано:{{ ($root.c[2].id_answer = radioGroup2[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup3">
						...
						<p>Выбрано:{{ ($root.c[3].id_answer = radioGroup3[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup4">
						...
						<p>Выбрано:{{ ($root.c[4].id_answer = radioGroup4[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup5">
						...
						<p>Выбрано:{{ ($root.c[5].id_answer = radioGroup5[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup6">
						...
						<p>Выбрано:{{ ($root.c[6].id_answer = radioGroup6[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup7">
						...
						<p>Выбрано:{{ ($root.c[7].id_answer = radioGroup7[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup8">
						...
						<p>Выбрано:{{ ($root.c[8].id_answer = radioGroup8[0]) }}</p>
					</v-radio-group>
				</v-container>
			</v-card-actions>
		</v-alert>
			...
			<v-card-actions>
				<v-container class="px-0" fluid border="left" style="margin-left: 40px">
					<v-radio-group v-model="radioGroup9">
						...
						<p>Выбрано:{{ ($root.c[9].id_answer = radioGroup9[0]) }}</p>
...
export default {
	...
	methods: {
		async init() {
			const res1 = await this.$axios.get('/test?theme=3&count_q=10')
